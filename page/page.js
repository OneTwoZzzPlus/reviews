...
`,$e="\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0435 \u043B\u043E\u0433\u0438\u043D \u0438\u043B\u0438 \u043F\u0430\u0440\u043E\u043B\u044C!",Ee="\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u043B\u043E\u0433\u0438\u043D \u0438 \u043F\u0430\u0440\u043E\u043B\u044C! \u041F\u0440\u043E\u0446\u0435\u0441\u0441 \u0430\u0432\u0442\u043E\u0440\u0438\u0437\u0430\u0446\u0438\u0438 \u0431\u044B\u043B \u043D\u0430\u0440\u0443\u0448\u0435\u043D",Q="\u0412\u0445\u043E\u0434",Ae="\u0412\u0445\u043E\u0434 \u231B",Pe='<span class="error">\u{1F494} \u0412\u044B\u0439\u0442\u0438 \u0438\u0437 \u0430\u043A\u043A\u0430\u0443\u043D\u0442\u0430</span>',Ne="\u{1F4DD} \u041D\u0430\u043F\u0438\u0441\u0430\u0442\u044C \u043E\u0442\u0437\u044B\u0432",Ie="\u{1F4CB} \u041C\u043E\u0434\u0435\u0440\u0430\u0446\u0438\u044F",B="\u041F\u043E\u0438\u0441\u043A \u043E\u0442\u0437\u044B\u0432\u043E\u0432",Re="\u0412\u0445\u043E\u0434",qe="\u041D\u043E\u0432\u044B\u0439 \u043E\u0442\u0437\u044B\u0432",_="\u041C\u043E\u0434\u0435\u0440\u0430\u0446\u0438\u044F",Be={delayed:"\u043D\u0430 \u0440\u0430\u0441\u0441\u043C\u043E\u0442\u0440\u0435\u043D\u0438\u0438",accepted:"\u043E\u043F\u0443\u0431\u043B\u0438\u043A\u043E\u0432\u0430\u043D",rejected:"\u043E\u0442\u043A\u043B\u043E\u043D\u0451\u043D"};function _e(){return`
    ...
    </details>`}function G(){let e=document.createElement("div");e.classList.add("suggestions-list-item"),e.innerHTML=ft();let t=pt(e);return Ot(e,t),e}function Ot(e,t){e.addEventListener("input",r=>{r.target===t.subject.checkbox&&(t.subject.checkbox.checked?(t.subject.id.placeholder="id",t.subject.id.disabled=!1):(t.subject.id.value="",t.subject.id.placeholder="\u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043D\u043E\u0432\u044B\u0439",t.subject.id.disabled=!0))});let n=!1,i=!1;e.addEventListener("submit",r=>{if(r.target===t.teacher.form){r.preventDefault();let s={id:k(b(t.teacher.id.value)),title:b(t.teacher.title.value)};if(s.id===null){alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0418\u0421\u0423 \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044F");return}if(s.title===""){alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0424\u0418\u041E \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044F");return}if(n)return;n=!0,et(s).then(a=>{alert(`\u041E\u0431\u043D\u043E\u0432\u043B\u0451\u043D \u0441 id: ${a.id}`),r.target.reset(),n=!1}).catch(a=>{alert(`\u0421\u0435\u0440\u0432\u0435\u0440 \u043E\u0442\u0432\u0435\u0442\u0438\u043B ${a}`),n=!1})}if(r.target===t.subject.form){r.preventDefault();let s={id:null,title:""};if(t.subject.checkbox.checked){if(s.id=k(b(t.subject.id.value)),s.title=b(t.subject.title.value),s.id===null){alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 ID \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0430");return}if(s.title===""){alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0430");return}}else if(s.id=null,s.title=b(t.subject.title.value),s.title===""){alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u043E\u0432\u043E\u0433\u043E \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0430");return}if(i)return;i=!0,tt(s).then(a=>{alert(`\u041E\u0431\u043D\u043E\u0432\u043B\u0451\u043D \u0441 id: ${a.id}`),r.target.reset(),i=!1}).catch(a=>{alert(`\u0421\u0435\u0440\u0432\u0435\u0440 \u043E\u0442\u0432\u0435\u0442\u0438\u043B ${a}`),i=!1})}})}var T,$,u,l,j,vt,ht,z,Tt,p="dashboard",R=!1,w=!1,bt,be;function yt(e,t=void 0){z=t,Tt=e,l=document.querySelector("#reviews-status-box"),$=document.querySelector("#reviews-isu-box"),u=document.querySelector("#reviews-container"),j=document.querySelector("#reviews-input"),vt=document.querySelector("#reviews-input-reset"),ht=document.querySelector("#reviews-menu"),T=document.querySelector("#reviews-header"),vt.addEventListener("click",()=>{j.value="",j.focus(),y()}),ht.addEventListener("click",y),j.addEventListener("input",gt),j.addEventListener("keydown",n=>{n.key==="Enter"&&gt()})}function y(){p="dashboard",T.innerHTML=B,l.innerHTML="",u.innerHTML="",u.appendChild(Oe(R,w,Tt,xt,Ft,J))}function ge(){p="login",T.innerHTML=Re,u.innerHTML="",u.appendChild(ct(z))}function Te(e){R=!0,$.innerHTML=He(e?.isu,e?.name),z!==void 0&&$.removeEventListener("click",ge),y(),Ke().then(t=>{t?.access&&(w=!0,console.log("You are moderator: ",w),y())}).catch(()=>{})}function Y(e){R=!1,w=!1,$.innerHTML=e,z!==void 0&&($.removeEventListener("click",ge),$.addEventListener("click",ge)),y()}function gt(){p="search",clearTimeout(bt),bt=setTimeout(Ut,300)}async function Ut(){let e=j.value.trim();if(e){if(e.length<3){l.innerHTML=Me;return}}else{l.innerHTML="";return}l.innerHTML=K,be?.abort(),be=new AbortController,D(e,be).then(t=>{if(t.results.length===0){l.innerHTML=E(404);return}if(p!=="search")return;T.innerHTML=B;let n=A(t,(i,r)=>{p==="search"&&xt(i,r)},w);n?(l.innerHTML="",u.innerHTML="",u.appendChild(n)):(u.innerHTML="",l.innerHTML=q)}).catch(t=>{p==="search"&&(T.innerHTML=B,u.innerHTML="",l.innerHTML=E(t))})}async function xt(e,t){switch(p="reviews",l.innerHTML=K,t){case"teacher":Xe(e).then(n=>{let i=st(n,R);if(p==="reviews"){if(i!==null){l.innerHTML="",u.innerHTML="",u.appendChild(i);return}l.innerHTML=W,p="search"}}).catch(n=>{l.innerHTML=Z(n),p="search"});break;case"subject":Ge(e).then(n=>{let i=at(n,R);if(p==="reviews"){if(i!==null){l.innerHTML="",u.innerHTML="",u.appendChild(i);return}l.innerHTML=W,p="search"}}).catch(n=>{l.innerHTML=Z(n),p="search"});break;default:console.error(`\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 type ${t}`),l.innerHTML=ke,p="search"}}function Ft(){p="add-review",T.innerHTML=qe,l.innerHTML="",u.innerHTML="",u.appendChild(X(y))}function J(){if(!w)return;p="moderator",T.innerHTML=_,l.innerHTML="\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u043A\u0438...",u.innerHTML="",u.appendChild(G());let e=document.createElement("button");e.classList.add("rev-button-s"),e.style.margin="0 0 0.5rem 0",e.innerHTML="\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u0442\u043E\u0440\u043E\u043D\u043D\u0438\u0439 \u043E\u0442\u0437\u044B\u0432",e.addEventListener("click",Dt),u.appendChild(e),Ve().then(t=>{p==="moderator"&&(l.innerHTML="",t.items.length===0&&(l.innerHTML="\u041F\u0440\u0435\u0434\u043B\u043E\u0436\u043A\u0430 \u043F\u0443\u0441\u0442\u0430 =)"),u.appendChild(mt(Xt,t)))}).catch(t=>{l.innerHTML=`\u0421\u0435\u0440\u0432\u0435\u0440 \u043E\u0442\u0432\u0435\u0442\u0438\u043B ${t}`})}function Dt(){w&&(p="moderator-external",T.innerHTML=_,l.innerHTML="",u.innerHTML="",u.appendChild(G()),u.appendChild(X(J,null,!0,!0)))}function Xt(e){w&&(p="moderator-review",T.innerHTML=_,l.innerHTML="\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u043E\u0442\u0437\u044B\u0432\u0430...",We(e).then(t=>{l.innerHTML="",u.innerHTML="",u.appendChild(G()),u.appendChild(X(J,t,!0))}).catch(t=>{J(),t===404&&(l.innerHTML="\u041D\u0435\u0442 \u0442\u0430\u043A\u043E\u0433\u043E \u043E\u0442\u0437\u044B\u0432\u0430 \u0432 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u043A\u0435 =("),l.innerHTML=`\u0421\u0435\u0440\u0432\u0435\u0440 \u043E\u0442\u0432\u0435\u0442\u0438\u043B ${t}`}))}var ye="<a>\u0412\u0445\u043E\u0434</a>",Gt="\u0412\u044B \u0442\u043E\u0447\u043D\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0432\u044B\u0439\u0442\u0438 \u0438\u0437 \u0430\u043A\u043A\u0430\u0443\u043D\u0442\u0430?";document.addEventListener("DOMContentLoaded",Jt);async function Jt(){yt(Yt,zt),ie().then(e=>{Te(e)}).catch(()=>{Y(ye)})}function zt(){ie().then(e=>{Te(e),y()}).catch(()=>{Y(ye)})}function Yt(){!Ue()||!confirm(Gt)||(se(),Y(ye),y())}})();
